...
3. **Commits restringidos durante F0.** Mientras dure la Fase 0 (auditoría), los commits solo pueden incluir archivos dentro de `docs/rebuild/audit/`. Excepciones a esta regla requieren instrucción explícita del usuario.
...
**F0 — Auditoría en curso.**

Las subfases F0.1–F0.9 se ejecutan secuencialmente, cada una con un deliverable en `docs/rebuild/audit/F0.X-*.md` y un commit aislado. La progresión requiere autorización explícita entre subfases.
