...
## Estado actual tras F1 closeout y F1 patterns de dominio
...
- F1.I quedo cerrado con documentacion minima, validacion y commit local.
- F1 patterns de dominio quedo cerrado localmente con `QuestionPage`, `InfoPanel` y `AssessmentLayout`.
- F2 queda pendiente de explicacion y autorizacion humana antes de abrirse.
