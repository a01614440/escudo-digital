    ...
    refuerzo: [
      {
        ...
        store: {
          ...
          guideMode: 'light',
          headerTagline: 'Setup creator · stock curado',
          sealLabel: 'Creator Week',
          heroTitle: 'Selección creator con combos muy bien diseñados',
          heroBody: 'El sitio se ve moderno y aspiracional, pero las señales delicadas aparecen en pagos, reseñas y soporte.',
          banner: 'Creator Week: beneficios extra al validar hoy',
          sub: 'Diseño limpio, checkout con fricción sutil y descuentos poco obvios.',
          contacto: 'Centro de ayuda por ticket y correo genérico; no aparece razón social.',
          pagos: ['Tarjeta', 'Transferencia con bono del 8%'],
          shipping: 'Tracking enviado después de validación manual del pedido.',
          reviews: 'Opiniones muy positivas, pero sin fotos, fechas ni perfiles enlazados.',
          policy: 'Cambios sujetos a revisión de inventario y validación del área de riesgo.',
          cartHeadline: 'Tu selección se apartó en fila preferente',
          cartNote: 'Reservamos tu carrito 09:45 min mientras validas el mejor método de pago.',
          checkoutHeadline: 'Confirma tu pedido con revisión manual',
          ...
          liveToasts: [
            'Andrea de Querétaro acaba de apartar una cámara Nova.',
            'Luis de Monterrey activó el combo creator hace 2 min.',
            'María de CDMX está validando su compra partner.',
          ],
          productos: [
            { nombre: 'Cámara Nova C1', antes: '$8,999', precio: '$7,299', badge: 'Creator pick', caption: 'Sensor 4K · setup móvil' },
            { nombre: 'Teclado Frame 75', antes: '$2,199', precio: '$1,849', badge: 'Bundle studio', caption: 'Wireless · creator desk' },
            { nombre: 'Monitor Halo 27"', antes: '$5,499', precio: '$4,699', badge: 'Edición color', caption: 'Panel IPS · 99% sRGB' },
          ],
        },
        hotspots: [
          ...
          { id: 'w2', target: 'contacto', label: 'Soporte sin empresa visible', correcta: true, explicacion: 'No muestra razón social ni domicilio verificable.' },
          { id: 'w3', target: 'pago', label: 'Bono extra por transferencia', correcta: true, explicacion: 'El incentivo empuja justo al método menos recuperable.' },
          ...
          { id: 'w5', target: 'shipping', label: 'Tracking diferido', correcta: false, explicacion: 'Puede ser una práctica rara, pero no basta por sí sola para decidir fraude.' },
        ],
      ...
      },
      {
        ...
        store: {
          ...
          layoutVariant: 'split',
          guideMode: 'light',
          headerTagline: 'Drop del mes · gadgets urbanos',
          sealLabel: 'Aniversario showroom',
          heroTitle: 'Bundles urbanos con compra anticipada',
          heroBody: 'La tienda se ve sobria y bien pensada, pero el checkout mete una validación extra y un flujo de pago más riesgoso.',
          banner: 'Beneficios por compra anticipada',
          sub: 'Diseño serio con una fricción peligrosa justo antes de pagar.',
          contacto: 'Formulario y correo; no aparece domicilio ni razón social.',
          pagos: ['Tarjeta', 'Depósito para asegurar inventario'],
          shipping: 'Entrega nacional con “seguro opcional” y tracking posterior.',
          ...
          cartNote: 'Tu pedido está casi listo y conserva precio anticipado por 08:35 min.',
          checkoutHeadline: 'Validación de inventario antes del pago final',
          checkoutPrompt: 'Depósito requerido para asegurar inventario en promoción.',
          reviewsLabel: 'Valoraciones del showroom',
          liveToasts: [
            'Pedro de León apartó un smartphone Lite hace 1 min.',
            'Diana de Puebla activó el beneficio de aniversario.',
            'Julio de Mérida está cerrando un bundle urbano.',
          ],
          productos: [
            { nombre: 'Smartphone Lite 5G', antes: '$6,499', precio: '$5,449', badge: 'Drop del mes', caption: 'Pantalla OLED · 128 GB' },
            { nombre: 'Audífonos Beam Pro', antes: '$1,599', precio: '$1,279', badge: 'Street audio', caption: 'ANC · batería extendida' },
            { nombre: 'Consola Pocket Neo', antes: '$4,799', precio: '$4,199', badge: 'Edición urbana', caption: 'Portátil · color graphite' },
          ],
        },
        hotspots: [
          { id: 'w1', target: 'pago', label: 'Depósito para asegurar inventario', correcta: true, explicacion: 'Es una excusa común para sacarte del pago con mayor protección.' },
          { id: 'w2', target: 'contacto', label: 'Contacto parcial y sin empresa', correcta: true, explicacion: 'Dificulta reclamar si algo sale mal.' },
          { id: 'w3', target: 'policy', label: 'Política abierta a interpretación', correcta: true, explicacion: 'No deja claras tus garantías reales como comprador.' },
          { id: 'w4', target: 'domain', label: 'Dominio plausible, pero demasiado armado', correcta: true, explicacion: 'Usa “showroom” para sonar oficial, sin que eso pruebe legitimidad.' },
          { id: 'w5', target: 'banner', label: 'Campaña de aniversario', correcta: false, explicacion: 'Una campaña bonita no es señal de fraude por sí sola.' },
        ],
    ...
    avanzado: [
      {
        ...
        store: {
          ...
          browserTitle: 'Luna Atelier | Casa y tecnología',
          themeVariant: 'premium',
          layoutVariant: 'editorial',
          guideMode: 'minimal',
          headerTagline: 'Curaduría hogar · edición weekend',
          sealLabel: 'Weekend picks',
          heroTitle: 'Colección hogar inteligente con precio protegido',
          heroBody: 'Todo se ve premium y coherente. Las señales reales están escondidas en validación, datos legales y letra pequeña.',
          banner: 'Weekend picks con envío preferente',
          sub: 'Precios razonables, reseñas creíbles y un checkout que no parece agresivo.',
          contacto: 'Chat, formulario y horario comercial. La razón social no aparece en el checkout.',
          pagos: ['Tarjeta', 'Transferencia para validación prioritaria'],
          shipping: 'Entrega estándar con seguimiento posterior a validación.',
          reviews: 'Reseñas creíbles, pero no enlazan a compradores verificables.',
          policy: 'Las promociones quedan fuera de devolución tras la validación del pedido.',
          cartHeadline: 'Tu selección mantiene precio protegido',
          cartNote: 'Tu selección conserva este precio durante 08:20 min.',
          checkoutHeadline: 'Validación prioritaria disponible',
          checkoutPrompt: 'Si eliges validación prioritaria, el pedido se confirma hoy.',
          reviewsLabel: 'Historias de compra',
          liveToasts: [
            'Claudia de CDMX acaba de cerrar una notebook Air.',
            'Tomás de Guadalajara reservó una tablet Home.',
            'Regina de Saltillo confirmó un pedido premium.',
          ],
          productos: [
            { nombre: 'Notebook Air 13', antes: '$13,999', precio: '$12,699', badge: 'Selección curada', caption: 'Aluminio · 16 GB RAM' },
            { nombre: 'Tablet Home 11', antes: '$5,499', precio: '$4,999', badge: 'Home pick', caption: 'Lápiz incluido · Wi-Fi 6' },
            { nombre: 'Barra de sonido Arc', antes: '$2,899', precio: '$2,499', badge: 'Audio studio', caption: 'Dolby Atmos · sala compacta' },
          ],
        },
        hotspots: [
          { id: 'w1', target: 'pago', label: 'Validación prioritaria por transferencia', correcta: true, explicacion: 'La presión es sutil, pero sigue moviéndote al método menos recuperable.' },
          { id: 'w2', target: 'policy', label: 'Promociones fuera de devolución', correcta: true, explicacion: 'La letra pequeña limita demasiado tus opciones reales.' },
          { id: 'w3', target: 'contacto', label: 'Razón social ausente', correcta: true, explicacion: 'Un comercio serio muestra empresa, razón social y canales formales.' },
          { id: 'w4', target: 'reviews', label: 'Reseñas estéticas', correcta: false, explicacion: 'Que las reseñas no tengan perfil visible es raro, pero no basta por sí solo para decidir.' },
        ],
      ...
      },
      {
        ...
        store: {
          ...
          guideMode: 'minimal',
          headerTagline: 'Desk objects · edición studio',
          sealLabel: 'Compra anticipada',
          heroTitle: 'Accesorios de escritorio con estética premium',
          heroBody: 'Diseño limpio, reseñas sobrias y checkout elegante. Las alertas son pocas, pero importan mucho.',
          banner: 'Beneficios por compra anticipada',
          sub: 'Todo parece normal hasta que el pago ofrece un beneficio extra con un método irrecuperable.',
          contacto: 'Formulario y correo; no muestra empresa ni domicilio en la confirmación.',
          pagos: ['Tarjeta', 'Cripto para conservar envío sin costo'],
          shipping: 'Entrega estándar sin sobrepromesas.',
          reviews: 'Comentarios breves, sin historial ni fotos de compra.',
          policy: 'Cancelaciones solo antes de la validación interna del pedido.',
          cartHeadline: 'Beneficio activo por compra anticipada',
          cartNote: 'Tu selección conserva este beneficio durante 07:10 min.',
          checkoutHeadline: 'Validación adicional para mantener beneficio',
          checkoutPrompt: 'Completa la validación adicional ahora para conservar el beneficio.',
          reviewsLabel: 'Notas de compradores',
          liveToasts: [
            'Iván de Aguascalientes aseguró envío sin costo.',
            'Sofía de Querétaro activó un beneficio anticipado.',
            'Mónica de Puebla está validando su pedido studio.',
          ],
          productos: [
            { nombre: 'Reloj Pulse One', antes: '$3,299', precio: '$2,999', badge: 'Desk edit', caption: 'Acero mate · correa tejida' },
            { nombre: 'Teclado Air Slim', antes: '$1,899', precio: '$1,699', badge: 'Workspace', caption: 'Perfil bajo · triple pairing' },
            { nombre: 'Hub USB-C Stone', antes: '$899', precio: '$799', badge: 'Studio mini', caption: 'Aluminio · 7 puertos' },
          ],
        },
        hotspots: [
          { id: 'w1', target: 'pago', label: 'Cripto para conservar envío sin costo', correcta: true, explicacion: 'Te empuja al método menos recuperable con un beneficio pequeño pero efectivo.' },
          { id: 'w2', target: 'policy', label: 'Cancelación limitada por validación interna', correcta: true, explicacion: 'El checkout redefine el proceso a favor de la tienda.' },
          { id: 'w3', target: 'contacto', label: 'Empresa ausente en la confirmación', correcta: true, explicacion: 'Sin empresa o domicilio visible, reclamar se complica mucho.' },
          { id: 'w4', target: 'domain', label: 'Dominio creíble', correcta: false, explicacion: 'Aquí el dominio por sí solo no basta para descartar ni confirmar fraude.' },
        ],
  ...
  return {
    ...
    actividades: arrangeModuleActivities({
      ...
      mk(2, {
        ...
        intro:
          modNivel === 'avanzado'
            ? 'Recorre producto, carrito y checkout. Marca solo las señales que realmente te harían frenar la compra.'
            : modNivel === 'refuerzo'
              ? 'Explora la tienda y marca las señales que sí afectarían tu decisión antes de pagar.'
